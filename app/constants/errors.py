...
AGENT_PERSIST = "[agent_utils.persist_conversation] error"
...
EXTRACT_SCORE_FROM_JUDGMENT = "[eval.extract_score_from_judgment] error"
COMPUTE_SCORES = "[eval.compute_scores] error"
CHUNK_TEXT = "[ingestion.chunk_text] error"
SAFE_METADATA = "[ingestion.safe_metadata] error"
CALCULATOR_EVAL = "[tools.calculator.eval] error"
CALCULATOR_TOOL = "[tools.calculator.calculator_tool] error"
FILTER_HALLUCINATIONS = "[safety.filter_hallucinations] error"
GET_CACHED_EMBEDDING = "[retrieval.get_cached_embedding] error"
